...
complete multi-phrase source as a final health proof.
...
a final source that does not produce both pinned phrase markers and exact
TextEdit insertion. Deterministic fixture tests remain mandatory for fault paths;
this paid canary is additional evidence and cannot replace them.
