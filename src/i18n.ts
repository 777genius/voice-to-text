...
const messages = {
  en: {
    ...
    settings: {
      ...
      textSize: {
        label: 'Transcription text size: {value}px',
        small: 'Smaller',
        large: 'Larger',
      },
      cancel: 'Cancel',
  ...
  ru: {
    ...
    settings: {
      ...
      textSize: {
        label: 'Размер текста транскрипции: {value}px',
        small: 'Меньше',
        large: 'Больше',
      },
      cancel: 'Отмена',
  ...
  es: {
    ...
    settings: {
      ...
      textSize: {
        label: 'Tamaño del texto: {value}px',
        small: 'Más pequeño',
        large: 'Más grande',
      },
      cancel: 'Cancelar',
  ...
  fr: {
    ...
    settings: {
      ...
      textSize: {
        label: 'Taille du texte : {value}px',
        small: 'Plus petit',
        large: 'Plus grand',
      },
      cancel: 'Annuler',
  ...
  uk: {
    ...
    settings: {
      ...
      textSize: {
        label: 'Розмір тексту транскрипції: {value}px',
        small: 'Менше',
        large: 'Більше',
      },
      cancel: 'Скасувати',
