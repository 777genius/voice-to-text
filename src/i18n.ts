...
const messages = {
  en: {
    ...
    main: {
      ...
      healthCheck: 'Call readiness',
      healthCheckStart: 'Check call readiness',
      healthCheckRunning: 'Checking...',
      healthCheckReady: 'Ready',
      healthCheckNeedsAttention: 'Needs attention',
    },
    settings: {
      title: 'Settings',
      feedback: {
      ...
      recordingMode: {
        ...
        hintBody: 'Voice to text uses the configured STT provider. Live translation streams to OpenAI realtime translate and writes translated voice to the platform virtual microphone.',
        platformStatusChecking: 'Checking live translation audio setup...',
        platformStatusUnavailable: 'Live translation audio setup status is not available.',
        virtualMicrophone: 'Virtual microphone: {name}',
      },
      incomingTranslation: {
        label: 'Incoming translation',
        captionsOnly: 'Text only',
        textAndAudio: 'Text and audio',
        volume: 'Translated audio volume',
        capabilityChecking: 'Checking spoken translation support...',
        capabilities: {
          ready: 'Translated speech will play through the system default output.',
          unsupported_platform: 'Spoken incoming translation is currently available on macOS only.',
          permission_required: 'Screen and System Audio Recording permission is required.',
          unsafe_self_capture: 'Playback cannot be safely excluded from system audio capture.',
          no_output_device: 'No system default output device is available.',
          unsupported_target_language: 'The selected recognition language is not supported for spoken translation.',
        },
      },
      autoActions: {
        ...
        completionSound: 'Play sound after transcription finishes',
        hideWindowOnHotkey: 'Do not show the recording window when using the hotkey',
        showMiniWindow: 'Show miniature recording window',
        manualStopOnly: 'Keep recording until I stop it manually',
        keepMicrophoneReady: 'Keep microphone ready',
        hintKeepMicrophoneReady: 'Speeds up reopening dictation. Between recordings, idle microphone audio is discarded and is not saved or sent. The macOS microphone indicator stays on.',
        holdToRecord: 'Record only while I hold the hotkey',
        doubleSpaceHotkey: 'Use double Space as a recording hotkey',
        accessibilityTitle: 'Accessibility permission required',
        accessibilityBody: 'Auto-paste and double Space hotkey require permission in macOS settings.',
        ...
        hintPasteUnstablePlatforms: 'Windows and Linux are untested and may be unstable.',
        hintMacPermission: 'Requires Accessibility permission on macOS.',
        hintSoundTitle: 'Sound:',
        hintSoundBody: 'Plays a short success sound when recording finishes. Off by default.',
        hintHotkeyWindowTitle: 'Hotkey:',
        hintHotkeyWindowBody: 'Starts and stops recording without opening the recording window. Off by default.',
        hintWindowPositionTitle: 'Mini window:',
        hintWindowPositionBody: 'Shows a very compact recording window with the latest recognized line and remembers where you drag it.',
        hintManualStopTitle: 'Silence:',
        hintManualStopBody: 'By default recording stops after silence. Enable this only if you want continuous listening.',
        hintHoldToRecordBody: 'Press and hold the hotkey to record. Release it to stop after the current phrase finishes.',
        hintDoubleSpaceHotkeyBody: 'Press Space twice quickly to start or stop recording. The two inserted spaces are removed automatically. Off by default.',
      },
      device: {
    ...
    errors: {
      ...
      serverProcessing: 'The server could not process the audio. Start recording again.',
    ...
    profile: {
      ...
      plan: 'Plan',
      bonus: 'Bonus',
      bonusDetail: '{minutes} min on balance',
      usage: 'Usage',
      usageDetail: '{used} / {total} min used',
      usageBreakdown: 'Plan: {plan} min, bonus: {bonus} min',
      logout: 'Sign out',
  ...
  ru: {
    ...
    main: {
      ...
      incomingTranslationMute: 'Выключить звук перевода',
      incomingTranslationUnmute: 'Включить звук перевода',
      incomingDuplexHeadsetWarning: 'Используйте наушники при переводе обеих сторон звонка.',
      healthCheck: 'Готовность к звонку',
      healthCheckStart: 'Проверить готовность к звонку',
      healthCheckRunning: 'Проверяем...',
      healthCheckReady: 'Готово',
      healthCheckNeedsAttention: 'Нужно внимание',
    },
    settings: {
      title: 'Настройки',
      feedback: {
      ...
      recordingMode: {
        ...
        hintBody: 'Голос в текст использует выбранный STT-провайдер. Live-перевод стримит звук в OpenAI realtime translate и выводит переведенный голос в виртуальный микрофон платформы.',
        platformStatusChecking: 'Проверяем аудио-настройку live-перевода...',
        platformStatusUnavailable: 'Статус аудио-настройки live-перевода недоступен.',
        virtualMicrophone: 'Виртуальный микрофон: {name}',
      },
      incomingTranslation: {
        label: 'Входящий перевод',
        captionsOnly: 'Только текст',
        textAndAudio: 'Текст и звук',
        volume: 'Громкость переведённой речи',
        capabilityChecking: 'Проверяем поддержку озвученного перевода...',
        capabilities: {
          ready: 'Переведённая речь будет звучать через системное устройство вывода.',
          unsupported_platform: 'Озвученный входящий перевод сейчас доступен только на macOS.',
          permission_required: 'Нужно разрешение на запись экрана и системного аудио.',
          unsafe_self_capture: 'Нельзя безопасно исключить перевод из захвата системного звука.',
          no_output_device: 'Системное устройство вывода недоступно.',
          unsupported_target_language: 'Выбранный язык распознавания не поддерживает озвученный перевод.',
        },
      },
      autoActions: {
        ...
        completionSound: 'Проигрывать звук после завершения распознавания',
        hideWindowOnHotkey: 'Не показывать окно записи при использовании хоткея',
        showMiniWindow: 'Показывать миниатюрное окно',
        manualStopOnly: 'Продолжать запись, пока я не остановлю её вручную',
        keepMicrophoneReady: 'Держать микрофон готовым',
        hintKeepMicrophoneReady: 'Ускоряет повторное открытие диктовки. Между записями звук с простаивающего микрофона отбрасывается, не сохраняется и не отправляется. Индикатор микрофона macOS остаётся включён.',
        holdToRecord: 'Записывать только пока я держу хоткей',
        doubleSpaceHotkey: 'Использовать двойной пробел как хоткей записи',
        accessibilityTitle: 'Требуется разрешение Accessibility',
        accessibilityBody: 'Для автовставки и хоткея по двойному пробелу нужно разрешение в настройках macOS.',
        ...
        hintPasteUnstablePlatforms: 'На Windows и Linux не тестировалось и может работать нестабильно.',
        hintMacPermission: 'Требует разрешения Accessibility на macOS.',
        hintSoundTitle: 'Звук:',
        hintSoundBody: 'Проигрывает короткий звук успеха после завершения записи. По умолчанию выключено.',
        hintHotkeyWindowTitle: 'Хоткей:',
        hintHotkeyWindowBody: 'Запускает и останавливает запись без открытия окна записи. По умолчанию выключено.',
        hintWindowPositionTitle: 'Мини-окно:',
        hintWindowPositionBody: 'Показывает очень компактное окно записи с последней распознанной строкой и запоминает позицию после перетаскивания.',
        hintManualStopTitle: 'Тишина:',
        hintManualStopBody: 'По умолчанию запись останавливается после тишины. Включайте только для постоянного прослушивания.',
        hintHoldToRecordBody: 'Нажмите и держите хоткей для записи. При отпускании запись остановится после завершения текущей фразы.',
        hintDoubleSpaceHotkeyBody: 'Быстро нажмите пробел два раза, чтобы начать или остановить запись. Два введённых пробела удалятся автоматически. По умолчанию выключено.',
      },
      device: {
    ...
    errors: {
      ...
      serverProcessing: 'Сервер не смог обработать аудио. Запустите запись ещё раз.',
      ...
      limitExceededShort: 'Лимит исчерпан',
    ...
    profile: {
      ...
      plan: 'План',
      bonus: 'Бонусы',
      bonusDetail: '{minutes} мин. на балансе',
      usage: 'Использование',
      usageDetail: '{used} / {total} мин. использовано',
      usageBreakdown: 'План: {plan} мин., бонусы: {bonus} мин.',
      logout: 'Выйти',
      loggingOut: 'Выход...',
      claim: {
  ...
  es: {
    ...
    main: {
      ...
      incomingTranslationMute: 'Silenciar audio traducido',
      incomingTranslationUnmute: 'Activar audio traducido',
      incomingDuplexHeadsetWarning: 'Usa auriculares al traducir ambos lados de una llamada.',
      healthCheck: 'Call readiness',
      healthCheckStart: 'Check call readiness',
      healthCheckRunning: 'Checking...',
      healthCheckReady: 'Ready',
    ...
    settings: {
      ...
      recordingMode: {
        ...
        hintBody: 'Voz a texto usa el proveedor STT configurado. Traducción en directo transmite audio a OpenAI realtime translate y envía la voz traducida al micrófono virtual de la plataforma.',
        platformStatusChecking: 'Comprobando la configuración de audio de traducción en directo...',
        platformStatusUnavailable: 'El estado de audio de traducción en directo no está disponible.',
        virtualMicrophone: 'Micrófono virtual: {name}',
      },
      incomingTranslation: {
        label: 'Traducción entrante',
        captionsOnly: 'Solo texto',
        textAndAudio: 'Texto y audio',
        volume: 'Volumen del audio traducido',
        capabilityChecking: 'Comprobando compatibilidad...',
        capabilities: {
          ready: 'La voz traducida se reproducirá por la salida predeterminada.',
          unsupported_platform: 'La traducción hablada entrante solo está disponible en macOS.',
          permission_required: 'Se requiere permiso para grabar pantalla y audio del sistema.',
          unsafe_self_capture: 'No se puede excluir la reproducción de la captura de forma segura.',
          no_output_device: 'No hay una salida de audio predeterminada disponible.',
          unsupported_target_language: 'El idioma seleccionado no admite traducción hablada.',
        },
      },
      autoActions: {
        ...
        completionSound: 'Reproducir sonido al terminar la transcripción',
        hideWindowOnHotkey: 'No mostrar la ventana de grabación al usar el atajo',
        showMiniWindow: 'Mostrar ventana de grabación miniatura',
        manualStopOnly: 'Mantener la grabación hasta detenerla manualmente',
        keepMicrophoneReady: 'Mantener el micrófono preparado',
        hintKeepMicrophoneReady: 'Acelera la reapertura del dictado. Entre grabaciones, el audio inactivo del micrófono se descarta y no se guarda ni se envía. El indicador del micrófono de macOS permanece encendido.',
        holdToRecord: 'Grabar solo mientras mantengo el atajo',
        doubleSpaceHotkey: 'Usar doble Espacio como atajo de grabación',
        accessibilityTitle: 'Se requiere permiso de Accesibilidad',
        accessibilityBody: 'El pegado automático y el atajo de doble Espacio requieren permiso en macOS.',
        ...
        hintPasteUnstablePlatforms: 'Windows y Linux no se han probado y pueden ser inestables.',
        hintMacPermission: 'Requiere permiso de Accesibilidad en macOS.',
        hintSoundTitle: 'Sonido:',
        hintSoundBody: 'Reproduce un sonido breve de éxito al terminar la grabación. Desactivado por defecto.',
        hintHotkeyWindowTitle: 'Atajo:',
        hintHotkeyWindowBody: 'Inicia y detiene la grabación sin abrir la ventana. Desactivado por defecto.',
        hintWindowPositionTitle: 'Ventana mini:',
        hintWindowPositionBody: 'Muestra una ventana de grabación muy compacta con la última línea reconocida y recuerda dónde la arrastra.',
        hintManualStopTitle: 'Silencio:',
        hintManualStopBody: 'Por defecto la grabación se detiene tras el silencio. Actívelo solo para escucha continua.',
        hintHoldToRecordBody: 'Mantenga presionado el atajo para grabar. Al soltarlo, se detendrá después de terminar la frase actual.',
        hintDoubleSpaceHotkeyBody: 'Pulse Espacio dos veces rápidamente para iniciar o detener la grabación. Los dos espacios insertados se eliminan automáticamente. Desactivado por defecto.',
      },
      device: {
    ...
    errors: {
      ...
      serverProcessing: 'El servidor no pudo procesar el audio. Inicie la grabación de nuevo.',
      ...
      limitExceededShort: 'Límite agotado',
    ...
    profile: {
      ...
      plan: 'Plan',
      bonus: 'Bonos',
      bonusDetail: '{minutes} min en balance',
      usage: 'Uso',
  ...
  fr: {
    ...
    main: {
      ...
      incomingTranslationMute: 'Couper l’audio traduit',
      incomingTranslationUnmute: 'Rétablir l’audio traduit',
      incomingDuplexHeadsetWarning: 'Utilisez un casque pour traduire les deux côtés d’un appel.',
      healthCheck: 'Call readiness',
      healthCheckStart: 'Check call readiness',
      healthCheckRunning: 'Checking...',
      healthCheckReady: 'Ready',
    ...
    settings: {
      ...
      recordingMode: {
        ...
        hintBody: 'Voix vers texte utilise le fournisseur STT configuré. Traduction en direct envoie l’audio à OpenAI realtime translate et la voix traduite vers le micro virtuel de la plateforme.',
        platformStatusChecking: 'Vérification de la configuration audio de traduction en direct...',
        platformStatusUnavailable: 'Le statut audio de traduction en direct est indisponible.',
        virtualMicrophone: 'Micro virtuel : {name}',
      },
      incomingTranslation: {
        label: 'Traduction entrante',
        captionsOnly: 'Texte uniquement',
        textAndAudio: 'Texte et audio',
        volume: 'Volume de la voix traduite',
        capabilityChecking: 'Vérification de la compatibilité...',
        capabilities: {
          ready: 'La voix traduite sera lue sur la sortie système par défaut.',
          unsupported_platform: 'La traduction vocale entrante est disponible uniquement sur macOS.',
          permission_required: 'L’autorisation d’enregistrer l’écran et l’audio système est requise.',
          unsafe_self_capture: 'La lecture ne peut pas être exclue de la capture en toute sécurité.',
          no_output_device: 'Aucune sortie audio système par défaut n’est disponible.',
          unsupported_target_language: 'La langue sélectionnée ne prend pas en charge la traduction vocale.',
        },
      },
      autoActions: {
        ...
        completionSound: 'Jouer un son à la fin de la transcription',
        hideWindowOnHotkey: 'Ne pas afficher la fenêtre d’enregistrement avec le raccourci',
        showMiniWindow: 'Afficher la mini fenêtre d’enregistrement',
        manualStopOnly: 'Continuer l’enregistrement jusqu’à l’arrêt manuel',
        keepMicrophoneReady: 'Garder le microphone prêt',
        hintKeepMicrophoneReady: 'Accélère la réouverture de la dictée. Entre les enregistrements, le son du microphone inactif est ignoré, non enregistré et non envoyé. Le voyant du microphone macOS reste allumé.',
        holdToRecord: "Enregistrer seulement pendant l'appui sur le raccourci",
        doubleSpaceHotkey: "Utiliser double Espace comme raccourci d'enregistrement",
        accessibilityTitle: 'Permission Accessibilité requise',
        accessibilityBody: 'Le collage automatique et le raccourci double Espace nécessitent une permission sur macOS.',
        ...
        hintPasteUnstablePlatforms: 'Windows et Linux ne sont pas testés et peuvent être instables.',
        hintMacPermission: 'Nécessite la permission Accessibilité sur macOS.',
        hintSoundTitle: 'Son :',
        hintSoundBody: 'Joue un court son de réussite à la fin de l’enregistrement. Désactivé par défaut.',
        hintHotkeyWindowTitle: 'Raccourci :',
        hintHotkeyWindowBody: 'Démarre et arrête l’enregistrement sans ouvrir la fenêtre. Désactivé par défaut.',
        hintWindowPositionTitle: 'Mini fenêtre :',
        hintWindowPositionBody: 'Affiche une fenêtre d’enregistrement très compacte avec la dernière ligne reconnue et mémorise sa position.',
        hintManualStopTitle: 'Silence :',
        hintManualStopBody: 'Par défaut, l’enregistrement s’arrête après un silence. Activez cela seulement pour une écoute continue.',
        hintHoldToRecordBody: "Maintenez le raccourci pour enregistrer. Au relachement, l'enregistrement s'arrete apres la phrase en cours.",
        hintDoubleSpaceHotkeyBody: "Appuyez deux fois rapidement sur Espace pour demarrer ou arreter l'enregistrement. Les deux espaces inseres sont supprimes automatiquement. Desactive par defaut.",
      },
      device: {
    ...
    errors: {
      ...
      serverProcessing: "Le serveur n'a pas pu traiter l'audio. Relancez l'enregistrement.",
      ...
      limitExceededShort: 'Limite atteinte',
    ...
    profile: {
      ...
      plan: 'Forfait',
      bonus: 'Bonus',
      bonusDetail: '{minutes} min en solde',
      usage: 'Utilisation',
      usageDetail: '{used} / {total} min utilisées',
      usageBreakdown: 'Forfait : {plan} min, bonus : {bonus} min',
      logout: 'Déconnexion',
  ...
  de: {
    ...
    main: {
      ...
      incomingTranslationMute: 'Übersetztes Audio stummschalten',
      incomingTranslationUnmute: 'Übersetztes Audio einschalten',
      incomingDuplexHeadsetWarning: 'Verwende Kopfhörer, wenn beide Seiten übersetzt werden.',
      healthCheck: 'Call readiness',
      healthCheckStart: 'Check call readiness',
      healthCheckRunning: 'Checking...',
      healthCheckReady: 'Ready',
    ...
    settings: {
      ...
      recordingMode: {
        ...
        hintBody: 'Sprache zu Text nutzt den konfigurierten STT-Provider. Live-Übersetzung streamt Audio an OpenAI realtime translate und sendet die übersetzte Stimme an das virtuelle Mikrofon der Plattform.',
        platformStatusChecking: 'Audio-Setup für Live-Übersetzung wird geprüft...',
        platformStatusUnavailable: 'Audio-Setup-Status für Live-Übersetzung ist nicht verfügbar.',
        virtualMicrophone: 'Virtuelles Mikrofon: {name}',
      },
      incomingTranslation: {
        label: 'Eingehende Übersetzung',
        captionsOnly: 'Nur Text',
        textAndAudio: 'Text und Audio',
        volume: 'Lautstärke der Übersetzung',
        capabilityChecking: 'Unterstützung wird geprüft...',
        capabilities: {
          ready: 'Die übersetzte Stimme wird über die Standardausgabe wiedergegeben.',
          unsupported_platform: 'Gesprochene eingehende Übersetzung ist derzeit nur unter macOS verfügbar.',
          permission_required: 'Die Berechtigung für Bildschirm- und Systemaudioaufnahme ist erforderlich.',
          unsafe_self_capture: 'Die Wiedergabe kann nicht sicher von der Aufnahme ausgeschlossen werden.',
          no_output_device: 'Kein Standard-Ausgabegerät ist verfügbar.',
          unsupported_target_language: 'Die ausgewählte Sprache unterstützt keine gesprochene Übersetzung.',
        },
      },
      autoActions: {
        ...
        completionSound: 'Ton nach Abschluss der Transkription abspielen',
        hideWindowOnHotkey: 'Aufnahmefenster beim Hotkey nicht anzeigen',
        showMiniWindow: 'Mini-Aufnahmefenster anzeigen',
        manualStopOnly: 'Aufnahme fortsetzen, bis ich manuell stoppe',
        keepMicrophoneReady: 'Mikrofon bereithalten',
        hintKeepMicrophoneReady: 'Beschleunigt das erneute Öffnen des Diktats. Zwischen Aufnahmen wird inaktives Mikrofonaudio verworfen, nicht gespeichert und nicht gesendet. Die macOS-Mikrofonanzeige bleibt eingeschaltet.',
        holdToRecord: 'Nur aufnehmen, solange ich den Hotkey halte',
        doubleSpaceHotkey: 'Doppeltes Leerzeichen als Aufnahme-Hotkey verwenden',
        accessibilityTitle: 'Bedienungshilfe-Berechtigung erforderlich',
        accessibilityBody: 'Auto-Einfügen und der Doppel-Leerzeichen-Hotkey benötigen die Berechtigung in macOS.',
        ...
        hintPasteUnstablePlatforms: 'Windows und Linux sind nicht getestet und können instabil sein.',
        hintMacPermission: 'Erfordert Bedienungshilfe‑Berechtigung auf macOS.',
        hintSoundTitle: 'Ton:',
        hintSoundBody: 'Spielt einen kurzen Erfolgston ab, wenn die Aufnahme endet. Standardmäßig deaktiviert.',
        hintHotkeyWindowTitle: 'Hotkey:',
        hintHotkeyWindowBody: 'Startet und stoppt die Aufnahme ohne Aufnahmefenster. Standardmäßig deaktiviert.',
        hintWindowPositionTitle: 'Mini-Fenster:',
        hintWindowPositionBody: 'Zeigt ein sehr kompaktes Aufnahmefenster mit der zuletzt erkannten Zeile und merkt sich die verschobene Position.',
        hintManualStopTitle: 'Stille:',
        hintManualStopBody: 'Standardmäßig stoppt die Aufnahme nach Stille. Nur für dauerhaftes Zuhören aktivieren.',
        hintHoldToRecordBody: 'Hotkey gedrückt halten zum Aufnehmen. Beim Loslassen stoppt die Aufnahme nach dem aktuellen Satz.',
        hintDoubleSpaceHotkeyBody: 'Drücken Sie zweimal schnell die Leertaste, um die Aufnahme zu starten oder zu stoppen. Die zwei eingefügten Leerzeichen werden automatisch gelöscht. Standardmäßig deaktiviert.',
      },
      device: {
        label: 'Aufnahmegerät',
    ...
    errors: {
      ...
      serverProcessing: 'Der Server konnte das Audio nicht verarbeiten. Starten Sie die Aufnahme erneut.',
      ...
      limitExceededShort: 'Limit erreicht',
    ...
    profile: {
      ...
      plan: 'Tarif',
      bonus: 'Bonus',
      bonusDetail: '{minutes} Min. Guthaben',
      usage: 'Nutzung',
  ...
  uk: {
    ...
    main: {
      ...
      incomingTranslationMute: 'Вимкнути звук перекладу',
      incomingTranslationUnmute: 'Увімкнути звук перекладу',
      incomingDuplexHeadsetWarning: 'Використовуйте навушники під час перекладу обох сторін дзвінка.',
      healthCheck: 'Call readiness',
      healthCheckStart: 'Check call readiness',
      healthCheckRunning: 'Checking...',
      healthCheckReady: 'Ready',
    ...
    settings: {
      ...
      recordingMode: {
        ...
        hintBody: 'Голос у текст використовує налаштований STT-провайдер. Жива трансляція стрімить аудіо в OpenAI realtime translate і виводить перекладений голос у віртуальний мікрофон платформи.',
        platformStatusChecking: 'Перевіряємо аудіо-налаштування живого перекладу...',
        platformStatusUnavailable: 'Статус аудіо-налаштування живого перекладу недоступний.',
        virtualMicrophone: 'Віртуальний мікрофон: {name}',
      },
      incomingTranslation: {
        label: 'Вхідний переклад',
        captionsOnly: 'Лише текст',
        textAndAudio: 'Текст і звук',
        volume: 'Гучність перекладеної мови',
        capabilityChecking: 'Перевіряємо підтримку...',
        capabilities: {
          ready: 'Перекладена мова відтворюватиметься через системний вихід.',
          unsupported_platform: 'Озвучений вхідний переклад зараз доступний лише на macOS.',
          permission_required: 'Потрібен дозвіл на запис екрана та системного аудіо.',
          unsafe_self_capture: 'Неможливо безпечно виключити відтворення із захоплення.',
          no_output_device: 'Системний пристрій виводу недоступний.',
          unsupported_target_language: 'Вибрана мова не підтримує озвучений переклад.',
        },
      },
      autoActions: {
        ...
        completionSound: 'Відтворювати звук після завершення розпізнавання',
        hideWindowOnHotkey: 'Не показувати вікно запису під час використання хоткея',
        showMiniWindow: 'Показувати мініатюрне вікно',
        manualStopOnly: 'Продовжувати запис, доки я не зупиню його вручну',
        keepMicrophoneReady: 'Тримати мікрофон готовим',
        hintKeepMicrophoneReady: 'Пришвидшує повторне відкриття диктування. Між записами звук із неактивного мікрофона відкидається, не зберігається й не надсилається. Індикатор мікрофона macOS залишається ввімкненим.',
        holdToRecord: 'Записувати лише поки я тримаю хоткей',
        doubleSpaceHotkey: 'Використовувати подвійний пробіл як хоткей запису',
        accessibilityTitle: 'Потрібен дозвіл Accessibility',
        accessibilityBody: 'Для автовставки та хоткея подвійного пробілу потрібен дозвіл у налаштуваннях macOS.',
        ...
        hintPasteUnstablePlatforms: 'Windows і Linux не тестувалися та можуть працювати нестабільно.',
        hintMacPermission: 'Потребує дозволу Accessibility на macOS.',
        hintSoundTitle: 'Звук:',
        hintSoundBody: 'Відтворює короткий звук успіху після завершення запису. За замовчуванням вимкнено.',
        hintHotkeyWindowTitle: 'Хоткей:',
        hintHotkeyWindowBody: 'Запускає та зупиняє запис без відкриття вікна запису. За замовчуванням вимкнено.',
        hintWindowPositionTitle: 'Міні-вікно:',
        hintWindowPositionBody: 'Показує дуже компактне вікно запису з останнім розпізнаним рядком і запам’ятовує позицію після перетягування.',
        hintManualStopTitle: 'Тиша:',
        hintManualStopBody: 'За замовчуванням запис зупиняється після тиші. Вмикайте лише для постійного прослуховування.',
        hintHoldToRecordBody: 'Натисніть і тримайте хоткей для запису. Після відпускання запис зупиниться після завершення поточної фрази.',
        hintDoubleSpaceHotkeyBody: 'Швидко натисніть пробіл двічі, щоб почати або зупинити запис. Два введені пробіли буде видалено автоматично. За замовчуванням вимкнено.',
      },
      device: {
    ...
    errors: {
      ...
      serverProcessing: 'Сервер не зміг обробити аудіо. Запустіть запис ще раз.',
      ...
      limitExceededShort: 'Ліміт вичерпано',
    ...
    profile: {
      ...
      plan: 'План',
      bonus: 'Бонуси',
      bonusDetail: '{minutes} хв. на балансі',
      usage: 'Використання',
      usageDetail: '{used} / {total} хв. використано',
      usageBreakdown: 'План: {plan} хв., бонуси: {bonus} хв.',
      logout: 'Вийти',
      loggingOut: 'Вихід...',
      claim: {
