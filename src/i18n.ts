  ...
  en: {
    ...
    settings: {
      ...
      autoActions: {
        ...
        hintKeepMicrophoneReady: 'Speeds up reopening dictation. While the window is closed, audio is not saved or sent. The macOS microphone indicator stays on.',
  ...
  ru: {
    ...
    settings: {
      ...
      autoActions: {
        ...
        hintKeepMicrophoneReady: 'Ускоряет повторное открытие диктовки. При закрытом окне звук не сохраняется и не отправляется. Индикатор микрофона macOS остаётся включён.',
  ...
  es: {
    ...
    settings: {
      ...
      autoActions: {
        ...
        hintKeepMicrophoneReady: 'Acelera la reapertura del dictado. Con la ventana cerrada, el audio no se guarda ni se envía. El indicador del micrófono de macOS permanece encendido.',
  ...
  fr: {
    ...
    settings: {
      ...
      autoActions: {
        ...
        hintKeepMicrophoneReady: 'Accélère la réouverture de la dictée. Lorsque la fenêtre est fermée, le son ne sera ni enregistré ni envoyé. Le voyant du microphone macOS reste allumé.',
  ...
  de: {
    ...
    settings: {
      ...
      autoActions: {
        ...
        hintKeepMicrophoneReady: 'Beschleunigt das erneute Öffnen des Diktats. Bei geschlossenem Fenster wird kein Audio gespeichert oder gesendet. Die macOS-Mikrofonanzeige bleibt eingeschaltet.',
  ...
  uk: {
    ...
    settings: {
      ...
      autoActions: {
        ...
        hintKeepMicrophoneReady: 'Пришвидшує повторне відкриття диктування. Коли вікно закрите, звук не зберігається й не надсилається. Індикатор мікрофона macOS залишається ввімкненим.',
