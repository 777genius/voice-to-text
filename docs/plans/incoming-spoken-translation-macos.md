...
7. 30-60 minute synthetic и native spoken soaks не растят memory/queue latency.
...
- release soak включает минимум 25 полных spoken start/stop циклов с lifecycle counters и RSS evidence;
