...
.section-wave {
  ...
  z-index: 1;
  overflow: hidden;
  /* Плавно растворяем ровный нижний край контейнера */
...
.v-theme--dark .section-wave__path {
  fill: rgba(160, 140, 220, 0.05);
}

.v-theme--dark .section-wave__path--2 {
  fill: rgba(160, 140, 220, 0.03);
}
